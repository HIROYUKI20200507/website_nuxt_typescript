  ...
  <div>
    ...
    <div class="bg-gray-100 py-20 px-20">
      <div class="flex justify-between items-start">
          <div v-for="qiita in articles" class="bg-white mr-5 max-w-sm" :key="qiita">
            ...
            <div class="p-5">
              <h1 class="text-2xl font-bold text-blue-800 py-2 truncate">{{ qiita.title }}</h1>
              <p class="bg-white text-sm text-black truncate">{{ qiita.content }}</p>
              <a :href="qiita.link" class="py-2 mt-4 px-6 text-white bg-blue-500 inline-block rounded">Read More</a>
            </div>
          </div>
      </div>
    </div>
